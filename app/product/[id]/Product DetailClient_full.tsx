        ...
        <header className="fixed top-0 left-0 right-0 border-b border-gray-700 py-2 z-40 transition-all duration-300" style={{backgroundColor: 'var(--primary-color)'}}>
          <div className="max-w-[90%] mx-auto px-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <img src="/assets/logo/omelarosa.png" alt="الفاروق" className="h-10 w-10 object-contain" />
              <h1 className="text-base font-bold text-white">omelarosa</h1>
            </div>
      ...
      <header className="border-b border-gray-700 py-0 relative z-40" style={{backgroundColor: 'var(--primary-color)'}}>
        <div className="max-w-[80%] mx-auto px-4 flex items-center justify-between min-h-[80px]">
          <div className="flex items-center gap-8">
            <div className="flex items-center gap-3">
              <img src="/assets/logo/omelarosa.png" alt="الفاروق" className="h-20 w-20 object-contain" />
              <h1 className="text-xl font-bold text-white">omelarosa</h1>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-3 mb-4">
                <img src="/assets/logo/omelarosa.png" alt="الفاروق" className="h-8 w-8 object-contain" />
                <h5 className="font-bold text-lg text-white">omelarosa</h5>
              </div>
